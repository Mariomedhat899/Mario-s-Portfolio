  ...
  protected projects: Project[] = [
    {
      ...
      chips: ['.NET 10', 'ASP.NET Core', 'Ollama', 'nomic-embed-text', 'qwen2.5-coder', 'Vector Search', 'RAG'],
      details: [
        ...
        'Built with .NET 10 and Clean Architecture — modular, testable, and runs entirely on your machine.'
      ],
    ...
    },
    {
      ...
      chips: ['.NET 10', 'ASP.NET Core', 'EF Core', 'SQL Server', 'Clean Architecture', 'Identity', 'SMTP'],
      details: [
        ...
        'Built with Clean Architecture: Domain / Application / Infrastructure / API layers.'
      ],
      endpoints: ['GET /api/products', 'POST /api/auth/register', 'GET /api/alerts/low-stock'],
    ...
    },
    {
      ...
      chips: ['.NET 10', 'WinForms', 'EF Core', 'SQLite', 'Clean Architecture', 'Thermal Printing'],
      details: [
        ...
        'Designed for Arabic-first UX — RTL layouts, Arabic receipts, and proper currency formatting.'
      ],
    ...
    },
    {
      ...
      chips: ['.NET 8', 'ASP.NET Core', 'SQL Server', 'AI', 'Clean Architecture'],
      details: [
